...
<section id="panel">
    ...
    <div class="info-panel">
        ...
        <form action="#" method="post" enctype="multipart/form-data">
            <label class="header-table" for=""><h3>Добавить новую новость</h3></label>
            <div class="all-info">
                <div>
                    <div>
                ...
                <textarea name="short_content"><?php echo $options['short_content']; ?></textarea><br>
                <br>
                <label for="description">Полное описание новости</label> <br>
                <textarea name="content"><?php echo $options['content']; ?></textarea><br>
                <br>
                <div>
                    <div>
