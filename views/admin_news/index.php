...
<section id="panel">
    ...
    <div class="info-panel">
        ...
        <div class="button-add">
            <button class="add_art" onclick="location.href='/admin/news/create/'"><i class="fas fa-plus"></i> Добавить новость</button>
        </div>
        ...
        <label class="header-table" for=""><h3>Список новостей</h3></label>
        <table class="table table-hover">
            ...
            <tr>
                ...
                <td><?php echo News::getStatusText($news['status']); ?></td>
                <td><?php echo $news['date']; ?></td>
                <td>
                    <button class="tooltip-btn" title="Редактировать"
                            onclick="location.href='/admin/news/update/<?php echo $news['id']; ?>'">
                        <i class="fas fa-edit"></i>
                    </button>
                    <button
                            id="btn-tooltip colletction-<?php echo $news['id']; ?>"
                            data-toggle="modal"
