...
<section id="panel">
    ...
    <div class="info-panel">
        ...
        <div class="button-add">
            <button class="add_art" onclick="location.href='/admin/ticket/create/'"><i class="fas fa-plus"></i> Добавить билет</button>
        </div>
        ...
        <label class="header-table" for=""><h3>Список билетов</h3></label>
        <table class="table table-hover">
            ...
            <?php foreach ($ticketList as $ticket): ?>
                ...
                <tr>
                    ...
                    <td><?php echo Tickets::getTextAvailability($ticket['availability']); ?></td>
                    <td><?php echo Tickets::getStatusText($ticket['status']); ?></td>
                    <td>
                        <button class="tooltip-btn" title="Редактировать"
                                onclick="location.href='/admin/ticket/update/<?php echo $ticket['id']; ?>'">
                            <i class="fas fa-edit"></i>
                        </button>
                        <button
                                id="btn-tooltip colletction-<?php echo $ticket['id']; ?>"
                                data-toggle="modal" data-target=".bd-example-modal-sm"
                                class="tooltip-btn" title="Удалить"
                                onclick="deleletBtn(<?php echo $ticket['id']; ?>,3)">
