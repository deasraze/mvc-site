...
<head>
    ...
    <title>Редактировать вакансию <?php echo mb_strtolower($job['name']); ?></title>
    <!--    favicon-->
    ...
    <div class="info-panel">
        <div class="navigation-admin-panel">
            <ol>
                ...
                <li><a href="/admin/jobs/">Управление вакансиями</a></li>
                <li class="active">Редактирование вакансию</li>
            </ol>
        </div>
        ...
        <form action="#" method="post" enctype="multipart/form-data">
            <label class="header-table" for=""><h3>Редактировать вакансию <?php echo mb_strtolower($job['name']); ?></h3></label>
            <div class="all-info">
                <div>
                    <div>
                ...
                <textarea name="what_to_do"><?php echo $job['what_to_do']; ?></textarea> <br>
                <br>
                <label for="description">Требования к кандидату:</label> <br>
                <textarea name="requirements"><?php echo $job['requirements']; ?></textarea> <br>
                <br>
                <div>
                    <div>
                        <label for="">Статус</label>
                        <select name="status">
                            <option value="1" <?php if ($job['status'] == 1) echo ' selected'; ?>>Отображается</option>
                            <option value="0" <?php if ($job['status'] == 0) echo ' selected'; ?>>Скрыто</option>
                        </select>
                    </div>
                </div>
                <br>
                <div class="button-choice">
                    ...
                    <button type="button" id="btn-tooltip" data-toggle="modal" data-target=".bd-example-modal-sm" onclick="deleletBtn(<?php echo $job['id']; ?>,12)" class="delete-btn-admin">Удалить</button>
                </div>
            </div>
        </form>
    </div>
