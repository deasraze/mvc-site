...
<section id="panel">
    ...
    <div class="info-panel">
        ...
        <div class="button-add">
            <button class="add_art" onclick="location.href='/admin/jobs/create/'"><i class="fas fa-plus"></i> Добавить вакансию</button>
        </div>
        ...
        <label class="header-table" for=""><h3>Список вакансий</h3></label>
        <table class="table table-hover">
            <thead class="thead-light">
            <tr>
                <th scope="col">ID вакансии</th>
            ...
            <tr>
                ...
                <td><?php echo Jobs::getStatusText($job['status']); ?></td>
                <td>
                    <button class="tooltip-btn" title="Редактировать"
                            onclick="location.href='/admin/jobs/update/<?php echo $job['id']; ?>'">
                        <i class="fas fa-edit"></i>
                    </button>
                    <button
                            id="btn-tooltip colletction-<?php echo $job['id']; ?>"
                            data-toggle="modal"
                            data-target=".bd-example-modal-sm"
                            class="tooltip-btn" title="Удалить"
                            onclick="deleletBtn(<?php echo $job['id']; ?>, 11)">
