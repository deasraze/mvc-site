...
<section id="panel">
    ...
    <div class="info-panel">
        ...
        <div class="button-add">
            <button class="add_art" onclick="location.href='/admin/category/create/'"><i class="fas fa-plus"></i> Добавить категорию</button>
        </div>
        ...
        <label class="header-table" for=""><h3>Список категорий</h3></label>
                ...
                <tr>
                    ...
                    <td>
                        <button class="tooltip-btn" title="Редактировать"
                                onclick="location.href='/admin/category/update/<?php echo $category['id']; ?>'">
                            <i class="fas fa-edit"></i>
                        </button>

                        <button
                                id="btn-tooltip colletction-<?php echo $category['id']; ?>"
                                data-toggle="modal" data-target=".bd-example-modal-sm"
                                class="tooltip-btn" title="Удалить"
                                onclick="deleletBtn(<?php echo $category['id']; ?>,2)">
