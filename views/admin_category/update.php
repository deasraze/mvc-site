        ...
        <form action="#" method="post">
            ...
            <div class="all-info">
                ...
                <div class="button-choice">
                    ...
                    <button type="button" id="btn-tooltip" data-toggle="modal" data-target=".bd-example-modal-sm" onclick="deleletBtn(<?php echo $category['id']; ?>,7)" class="delete-btn-admin">Удалить</button>
                </div>
            </div>
        </form>
    </div>
