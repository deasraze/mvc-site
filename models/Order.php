...
class Order
{
     ...
     */
    public static function save($userName, $userPhone, $userComment, $userId, $tickets)
    {

        $db = Db::getConnection();

        // Делаем подготовленный запрос
        $sql = 'INSERT INTO ticket_order (user_name, user_phone, user_comment, user_id, tickets) '
            . 'VALUES (:user_name, :user_phone, :user_comment, :user_id, :tickets)';
